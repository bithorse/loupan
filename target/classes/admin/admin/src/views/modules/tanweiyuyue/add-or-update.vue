<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="街道区域" prop="jiedaoquyu">
          <el-input v-model="ruleForm.jiedaoquyu" 
              placeholder="街道区域" clearable  :readonly="ro.jiedaoquyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="街道区域" prop="jiedaoquyu">
              <el-input v-model="ruleForm.jiedaoquyu" 
                placeholder="街道区域" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="摊位号" prop="tanweihao">
          <el-input v-model="ruleForm.tanweihao" 
              placeholder="摊位号" clearable  :readonly="ro.tanweihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="摊位号" prop="tanweihao">
              <el-input v-model="ruleForm.tanweihao" 
                placeholder="摊位号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.tanweitupian" label="摊位图片" prop="tanweitupian">
          <file-upload
          tip="点击上传摊位图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.tanweitupian?ruleForm.tanweitupian:''"
          @change="tanweitupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.tanweitupian" label="摊位图片" prop="tanweitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tanweitupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="管理电话" prop="guanlidianhua">
          <el-input v-model="ruleForm.guanlidianhua" 
              placeholder="管理电话" clearable  :readonly="ro.guanlidianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="管理电话" prop="guanlidianhua">
              <el-input v-model="ruleForm.guanlidianhua" 
                placeholder="管理电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="摊主账号" prop="tanzhuzhanghao">
          <el-input v-model="ruleForm.tanzhuzhanghao" 
              placeholder="摊主账号" clearable  :readonly="ro.tanzhuzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="摊主账号" prop="tanzhuzhanghao">
              <el-input v-model="ruleForm.tanzhuzhanghao" 
                placeholder="摊主账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="摊主姓名" prop="tanzhuxingming">
          <el-input v-model="ruleForm.tanzhuxingming" 
              placeholder="摊主姓名" clearable  :readonly="ro.tanzhuxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="摊主姓名" prop="tanzhuxingming">
              <el-input v-model="ruleForm.tanzhuxingming" 
                placeholder="摊主姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="摊主手机" prop="tanzhushouji">
          <el-input v-model="ruleForm.tanzhushouji" 
              placeholder="摊主手机" clearable  :readonly="ro.tanzhushouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="摊主手机" prop="tanzhushouji">
              <el-input v-model="ruleForm.tanzhushouji" 
                placeholder="摊主手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.tanzhuzhanghao!=''&&json.tanzhuzhanghao){
                this.ruleForm.tanzhuzhanghao = json.tanzhuzhanghao
	    		this.ro.tanzhuzhanghao = true;
		}
		if(json.tanzhuxingming!=''&&json.tanzhuxingming){
                this.ruleForm.tanzhuxingming = json.tanzhuxingming
	    		this.ro.tanzhuxingming = true;
		}
		if(json.tanzhushouji!=''&&json.tanzhushouji){
                this.ruleForm.tanzhushouji = json.tanzhushouji
	    		this.ro.tanzhushouji = true;
		}
        } else {
	...
	if(this.ruleForm.tanweitupian!=null) {
		this.ruleForm.tanweitupian = this.ruleForm.tanweitupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tanweiyuyue/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tanweiyuyueCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    tanweitupianUploadChange(fileUrls) {
	this.ruleForm.tanweitupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
